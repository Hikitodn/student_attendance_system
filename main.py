...
# This part is image labels setting start 
        ...
        att_b1.place(x=550,y=100,width=180,height=180)
        ...
        att_b1_1.place(x=550,y=280,width=180,height=45)
